...
import 'dart:io';
import 'package:ashique_admin_app/model/BusinessRes.dart';
...
class BusinessSettingController extends GetxController {
  late DIO.Dio dio;
  final formKeySSL = GlobalKey<FormBuilderState>();
  List<Map<String, dynamic>> busisnessGrid = [
    ...
    },
    {
      ...
      'info':
          'Learn more about our company, mission, and values. Get insights into our journey.',
      'route': AboutUs.routeName,
    },
    {
      "Terms and Condition": Icons.quick_contacts_dialer,
      'info':
          'Read and agree to our terms and conditions to ensure smooth transactions.',
      'route': TermsAndConditions.routeName,
    },
    {
      "Privacy Policy": Icons.privacy_tip,
      'info':
          'Understand how we handle your data and ensure your privacy and security.',
      'route': PrivacyPolicy.routeName,
    },
    {
      "Seller Settings": Icons.sell,
      'info':
          'Customize your seller settings to optimize your selling experience.',
      'route': SellerSettings.routeName,
    },
    {
      "FAQ": Icons.question_mark,
      'info':
          'Find answers to commonly asked questions. Get support and guidance.',
  ...
  Rxn<BusinessRes> businessRes = Rxn<BusinessRes>();

  Future<bool> getSetting() async {
    String url = BUSNIESS_SETTING_URL;
    try {
      final DIO.Response response = await dio.get(url);
      Map<String, dynamic> map = response.data;
      businessRes.value = null;
      businessRes.value = BusinessRes.fromJson(map);
      return true;
