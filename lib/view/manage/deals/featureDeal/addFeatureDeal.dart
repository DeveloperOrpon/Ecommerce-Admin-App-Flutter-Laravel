...
class AddFeatureDeals extends StatelessWidget {
  const AddFeatureDeals({super.key});
    ...
    Future.delayed(
      const Duration(milliseconds: 100),
        ...
        Navigator.of(context).restorablePush(infoWithImageDialog,
            arguments:['assets/images/FeatureDeal.jpg',"The feature empowers users to include specific items in time-limited promotions, enhancing sales and customer engagement through targeted marketing strategies and exclusive offers."]);
      },
    );
    return Scaffold(
      appBar: AppBar(
          ...
          child: ListView(
            children: [
              ...
              const Padding(
                ...
                child: Text(
                  'Add FeatureDeals Thumbnail Image',
