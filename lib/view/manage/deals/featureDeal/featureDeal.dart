...
import 'addFeatureDeal.dart';
import 'addProductFeatureDeal.dart';

class FeatureDeals extends StatelessWidget {
  const FeatureDeals({super.key});
            ...
            children: [
              ...
              Row(
                children: [
                  InkWell(
                    onTap: () {
                      Get.to(const AddProductFeatureDeals(),
